...
var InputController=function(){
	...
	$('#wood-thickness-input').change(function () {
		var wood_thickness = parseInt($(this).val());
		if (!isNaN(wood_thickness) && wood_thickness == 0.125 || wood_thickness == 0.0625) { //to make sure the input is valid (is an integer and less than 10)
